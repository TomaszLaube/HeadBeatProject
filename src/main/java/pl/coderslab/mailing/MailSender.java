...
public class MailSender {
    ...
    public static void generateAndSendEmail(String user, String offered, String requested, String url) throws AddressException, MessagingException {
